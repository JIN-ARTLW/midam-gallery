...
업로드 페이지(`upload.html`) 안에 **올리기 / 관리** 탭이 함께 있습니다.
- 주소는 동일: **https://jin-artlw.github.io/midam-gallery/upload.html**
- 위쪽 **🗑 관리** 탭 → 비밀번호 입력 → 작품의 **🗑 삭제** 버튼 → 확인하면 삭제
- 비밀번호는 올리기·삭제 공용이며, 페이지 맨 위에 한 번만 입력하면 됩니다.
